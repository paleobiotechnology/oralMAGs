---
title: "Methanocatella methanogenesis genes tree and heatmap"
author: "Keri Burge"
...
methanocatella_methanogenesis_genes_presence_absence <- fread("05-results/methanocatella_methanogenesis_genes_presence_absence.tsv")

methanogenesis_gene_counts <- methanocatella_methanogenesis_genes_presence_absence %>%
...
methanogenesis_heatmap <- methanogenesis_gene_counts %>%
  ...
  ggplot(aes(x = Gene, y = Label, fill = Description)) +
...
methanocatella_tree_age_w_no_bootstraps <- methanocatella_tree %<+% metadata + 
...
methanocatella_tree_age_w_no_bootstraps
```

# combine
```{r}
methanocatella_tree_w_methanogenesis_heatmap <- methanogenesis_heatmap %>% insert_left(methanocatella_tree_age_w_no_bootstraps, width = 2) 

methanocatella_tree_w_methanogenesis_heatmap
